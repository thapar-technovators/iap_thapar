<!-- Mentor Registration -->
    <section id="mentor-registration" class="section text-center">
        <div class="container">
            ...
            <div class="row">
                ...
                echo form_open('register/mentor', $attributes);?>
                        ...
                        <div class="form-group">
                            <label for="comapany">Company Name<span style="color:red;">*</span></label>
                            <input type="text" name="company" id="company" required class="form-control" placeholder="Microsoft">
                        </div>
